...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("number53982016")

  // remove field
  collection.fields.removeById("number3968390153")

  // remove field
  collection.fields.removeById("number2238470518")

  // remove field
  collection.fields.removeById("number1223678364")

  // remove field
  collection.fields.removeById("number780788469")

  // remove field
  collection.fields.removeById("number3739234390")

  // remove field
  collection.fields.removeById("number1634912014")
